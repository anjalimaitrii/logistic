...
export default function AccountantJobDetail() {
  ...
  const calculations = useMemo(() => {
    ...
    const mileage = parseFloat(calcData.mileage) || 1;

    const pLiters = pKm / mileage;
    const pAmount = pLiters * pRate;

    const dLiters = dKm / mileage;
    const dAmount = dLiters * dRate;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-2xl md:rounded-[24px] p-5 md:p-6 shadow-sm border border-neutral-100">
                ...
                <div className="p-4 md:p-5 bg-neutral-50 rounded-xl md:rounded-2xl border border-neutral-100 mb-6 md:mb-6">
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-4 mb-4">
                    <div className="space-y-1">
                      <label className="text-[8px] md:text-[9px] font-medium text-neutral-400 uppercase tracking-widest ml-1">Description</label>
                      <input
                        type="text"
                    ...
                    <div className="space-y-1">
                      <label className="text-[8px] md:text-[9px] font-medium text-neutral-400 uppercase tracking-widest ml-1">Amount (₦)</label>
                      <input
                        type="number"
                    ...
                    <div className="space-y-1">
                      <label className="text-[8px] md:text-[9px] font-medium text-neutral-400 uppercase tracking-widest ml-1">Category</label>
                      <select
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="px-4 py-2 bg-neutral-100 text-slate-700 rounded-lg text-[9px] md:text-[10px] font-medium uppercase tracking-widest hover:bg-neutral-200 transition-all flex items-center justify-center gap-2 shadow-sm"
                    >
                      <Plus className="w-3 h-3" /> Add More
                    </button>
                    <button
                      onClick={handleAddTransaction}
                      className="px-6 py-2 bg-slate-900 text-white rounded-lg text-[9px] md:text-[10px] font-medium uppercase tracking-widest hover:bg-slate-800 transition-all flex items-center justify-center gap-2 shadow-sm"
                    >
                      <Check className="w-3 h-3" /> Save Ledger
                    </button>
                  </div>
                </div>
                ...
                <div className="space-y-4 md:space-y-5">
                  ...
                  <div className="p-4 rounded-xl md:rounded-2xl bg-neutral-50 border border-neutral-100 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="space-y-1">
                        <label className="text-[8px] font-medium text-neutral-400 uppercase tracking-widest ml-1 font-sans">Rate</label>
                        <input
                          type="number"
                  ...
                  <div className="px-1 py-1 flex items-center justify-between">
                    <label className="text-[8px] md:text-[9px] font-medium text-neutral-400 uppercase tracking-widest font-sans">Truck Mileage</label>
                    <div className="flex items-center gap-2">
                      <input
                        type="number"
                        value={calcData.mileage}
                        onChange={(e) => setCalcData({ ...calcData, mileage: e.target.value })}
                        className="w-10 bg-neutral-50 border-b-2 border-neutral-100 text-[11px] font-semibold text-slate-900 text-center outline-none"
                      />
                      <span className="text-[9px] font-medium text-neutral-400 font-sans">KM/L</span>
                    </div>
                  </div>
